    ...
    execute: function () {
      ...
      _export("EventManager", EventManager = (_dec = ccclass('EventManager'), _dec(_class = (_class2 = class EventManager extends Component {
        ...
        static off(eventName, callback, target) {
          ...
          var entries = this.events.get(eventName);
          if (!entries) return;
          var index = entries.findIndex(entry => entry.callback === callback && entry.target === target);
...
//# sourceMappingURL=9395253dbd87a03091b3adefc467c59ea84d8daf.js.map